...
const MenuBadge: React.FC<{
  ...
  <span
    className={`ml-auto ${
      isActive
        ? type === 'new' ? "menu-dropdown-badge-active" : "menu-dropdown-badge-pro-active"
        : type === 'new' ? "menu-dropdown-badge-inactive" : "menu-dropdown-badge-pro-inactive"
    } ${type === 'new' ? 'menu-dropdown-badge' : 'menu-dropdown-badge-pro'}`}
  >
    {type}
  </span>
);
  ...
  <li>
    ...
    >
      ...
      <span className="flex items-center gap-1 ml-auto">
        {subItem.new && <MenuBadge type="new" isActive={isActive(subItem.path)} />}
        {subItem.pro && <MenuBadge type="pro" isActive={isActive(subItem.path)} />}
      </span>
    </Link>
  </li>
);
              ...
              >
                <ul className="mt-2 space-y-1 ml-9">
                  {nav.subItems!.map((subItem) => (
                    <SubmenuItem key={subItem.name} subItem={subItem} isActive={isActive} />
                  ))}
                </ul>
              </div>
            )}
